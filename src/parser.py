...
def build_parser():
    ...
    parser.add_argument('--lambda_annoT', type=float, default=random.uniform(0, 1.0))
    parser.add_argument('--lambda_annoH', type=float, default=random.uniform(0, 1.0))
    parser.add_argument('--lambda_transT', type=float, default=random.uniform(0, 1.0))
    parser.add_argument('--lambda_transH', type=float, default=random.uniform(0, 1.0))
    parser.add_argument('--lambda_cross', type=float, default=random.uniform(0, 1.0))
