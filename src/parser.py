...
def build_parser():
    ...
    parser.add_argument('--use_cuda', type=bool, default=True, help="enable/disable CUDA")
    parser.add_argument('--use_sample', type=bool, default=False, help="use sample dataset")
