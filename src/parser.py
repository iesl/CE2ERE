...
def build_parser():
    ...
    parser.add_argument('--matres_threshold', type=float, default=-0.602059991,help= "log0.5: -0.301029996, log0.25: -0.602059991, log0.1: -1")
    ...
    parser.add_argument('--mlp_output_dim', type=int, default=32)
    parser.add_argument('--proj_output_dim', type = int, default=64)
    parser.add_argument('--hieve_mlp_size', type = int, default=64)
    parser.add_argument('--matres_mlp_size', type = int, default=32)
